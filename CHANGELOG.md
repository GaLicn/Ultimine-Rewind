...
- 撤回材料统计与消耗改为按物品及其组件精确匹配，提升对带有数据的模组物品的兼容性
  - Rewind material counting and consumption now precisely match items and their components, improving compatibility with modded items carrying data.
